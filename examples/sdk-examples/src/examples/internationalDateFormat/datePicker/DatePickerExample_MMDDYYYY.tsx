...
export const DatePickerExample_MMDDYYYY: React.FC = () => {
    ...
    return (
        <div className="s-date-picker">
            ...
            <label className="s-date-picker-from">
                <h4>From</h4>
                <Datepicker date={from.toDate()} onChange={onFromChange} dateFormat="MM/dd/yyyy" />
            </label>
            <label className="s-date-picker-to">
                <h4>To</h4>
                <Datepicker date={to.toDate()} onChange={onToChange} dateFormat="MM/dd/yyyy" />
            </label>

...
export const DatePickerExample_YYYYMMDD: React.FC = () => {
    ...
    return (
        <div className="s-date-picker">
            ...
            <label className="s-date-picker-from">
                <h4>From</h4>
                <Datepicker date={from.toDate()} onChange={onFromChange} dateFormat="yyyy-MM-dd" />
            </label>
            <label className="s-date-picker-to">
                <h4>To</h4>
                <Datepicker date={to.toDate()} onChange={onToChange} dateFormat="yyyy-MM-dd" />
            </label>
